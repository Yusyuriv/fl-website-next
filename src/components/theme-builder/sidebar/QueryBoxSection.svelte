...
import RadioGroup from "@/components/theme-builder/ui/inputs/RadioGroup.svelte";
...
const FONT_WEIGHTS: string[] = getContext("FONT_WEIGHTS");
</script>
...
<Section title="Query Box Style">
  ...
  <Group title="Time">
    ...
    <QuadrupleNumberInput
      label="Margins"
      bind:value1={state.queryBox.time.margins.top}
      bind:value2={state.queryBox.time.margins.right}
      bind:value3={state.queryBox.time.margins.bottom}
      bind:value4={state.queryBox.time.margins.left}
      line1="top"
      line2="right"
      line3="bottom"
      line4="left"
  ...
  <Group title="Date">
    ...
    <QuadrupleNumberInput
      label="Margins"
      bind:value1={state.queryBox.date.margins.top}
      bind:value2={state.queryBox.date.margins.right}
      bind:value3={state.queryBox.date.margins.bottom}
      bind:value4={state.queryBox.date.margins.left}
      line1="top"
      line2="right"
      line3="bottom"
      line4="left"
